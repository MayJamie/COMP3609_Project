...
public class HeartFragment {
	...
	public HeartFragment (JPanel panel, Player player, String image, int x, int y) {
		this.panel = panel;
		...
		spriteImage = ImageManager.loadImage("images/" + image);
	...
	public void setCollectedFalse() { collected = false; }
